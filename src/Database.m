...
%                 remove(obj.db_goods(""), 0);
                ...
                obj.db_goods(obj.db_goods_count) = Goods("¶à·Ò", "ãåÔ¡Â¶", 13, 'img\ÃÀ×±Ï´»¤\ãåÔ¡Â¶\dove.jpg');
                
                obj.db_goods_count = obj.db_goods_count + 1;
                obj.db_goods(obj.db_goods_count) = Goods("Ç¿Éú", "ãåÔ¡Â¶", 20, 'img\ÃÀ×±Ï´»¤\ãåÔ¡Â¶\johnson.jpg');
                
                obj.db_goods_count = obj.db_goods_count + 1;
                obj.db_goods(obj.db_goods_count) = Goods("º£·ÉË¿", "Ï´·¢Â¶", 18, 'img\ÃÀ×±Ï´»¤\Ï´·¢Â¶\hfs.jpg');
                
                obj.db_goods_count = obj.db_goods_count + 1;
                obj.db_goods(obj.db_goods_count) = Goods("Æ®Èá", "Ï´·¢Â¶", 15, 'img\ÃÀ×±Ï´»¤\Ï´·¢Â¶\rejoice.jpg');
