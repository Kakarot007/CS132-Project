    ...
    methods
        function obj= Database()
            ...
            if exist('data/cashier_db.mat','file')
                ...
                obj.db_goods(obj.db_goods_count) = Goods("¶à·Ò", "ãåÔ¡Â¶", 13);
                
                obj.db_goods_count = obj.db_goods_count + 1;
                obj.db_goods(obj.db_goods_count) = Goods("Ç¿Éú", "ãåÔ¡Â¶", 20);
                
                obj.db_goods_count = obj.db_goods_count + 1;
                obj.db_goods(obj.db_goods_count) = Goods("º£·ÉË¿", "Ï´·¢Â¶", 18);
                
                obj.db_goods_count = obj.db_goods_count + 1;
                obj.db_goods(obj.db_goods_count) = Goods("Æ®Èá", "Ï´·¢Â¶", 15);
